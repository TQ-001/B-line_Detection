...
def main():
    ...
    ngpus_per_node = torch.cuda.device_count()  # number of GPUs
    print("ngpus_per_node",ngpus_per_node)

    args.job_id = os.environ['SLURM_JOBID']  # Current job ID
    print("job_id",args.job_id)

    args.local_rank = int(os.environ["SLURM_PROCID"])  # Current local rank
...
master_gpu = 0  # Specify the master_gpu
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.distributed:
        ...
        if args.multiprocessing_distributed:
            ...
            args.dist_url = "file://{}.{}".format(os.path.realpath(args.dist_file), args.job_id)
    ...
    if args.aug_plus:
        ...
        augmentation = [
            ...
            # change from 224 here in order to be divisible by 3 in jigsaw augmentation
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        is_best = mean_total_loss < best_loss
        best_loss = min(mean_total_loss, best_loss)
